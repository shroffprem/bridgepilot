...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Mobile bottom nav */}
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border shadow-lg" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
          ...
          {visibleBottom.map(({ label, icon: Icon, path }) => {
            ...
            return (
              <Link
                ...
                to={path}
                className={cn(
                  'flex flex-col items-center justify-center gap-0.5 flex-1 active:bg-muted/50 touch-manipulation',
